...
fn main() {
    ...
    report(
        "normal cone r2 h3 +z",
        &cone(Vec3::ZERO, z, 2.0, 3.0),
        2.0,
        3.0,
    );
    report(
        "flat cone r3.13 h0.2 +z",
        &cone(Vec3::ZERO, z, 3.1299, 0.2),
        3.1299,
        0.2,
    );
    report(
        "flat cone r3.13 h0.2 tilt",
        &cone(Vec3::ZERO, tilt, 3.1299, 0.2),
        3.1299,
        0.2,
    );
    report(
        "tall cone r0.2 h3 +z",
        &cone(Vec3::ZERO, z, 0.2, 3.0),
        0.2,
        3.0,
    );
    report(
        "flat cone r3.13 h1.0 +z",
        &cone(Vec3::ZERO, z, 3.1299, 1.0),
        3.1299,
        1.0,
    );
    report(
        "flat cone r3.13 h0.5 +z",
        &cone(Vec3::ZERO, z, 3.1299, 0.5),
        3.1299,
        0.5,
    );
    report(
        "flat cone r3.13 h0.05 +z",
        &cone(Vec3::ZERO, z, 3.1299, 0.05),
        3.1299,
        0.05,
    );
    ...
    report(
        "flat tilt cone @far",
        &cone(far, tilt, 3.1299, 0.2),
        3.1299,
        0.2,
    );
    report(
        "flat tilt cone @z-5.88",
        &cone(Vec3::new(0., 0., -5.88), z, 3.1299, 0.2),
        3.1299,
        0.2,
    );
